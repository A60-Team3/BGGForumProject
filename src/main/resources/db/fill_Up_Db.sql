...
INSERT INTO users (first_name, last_name, email, username, password, user_role_id)
VALUES ('John', 'Doe', 'john.doe@example.com', 'john_doe', 'password123', 1),                      -- Admin
       ('Jane', 'Smith', 'jane.smith@example.com', 'jane_smith', 'password123', 2),                -- Moderator
       ('Alice', 'Johnson', 'alice.johnson@example.com', 'alice_johnson', 'password123', 3),       -- User
       ('Bob', 'Brown', 'bob.brown@example.com', 'bob_brown', 'password123', 3),                   -- User
       ('Charlie', 'Davis', 'charlie.davis@example.com', 'charlie_davis', 'password123', 1),       -- Admin
       ('Eva', 'Miller', 'eva.miller@example.com', 'eva_miller', 'password123', 1),                -- Admin
       ('Frank', 'Wilson', 'frank.wilson@example.com', 'frank_wilson', 'password123', 3),          -- User
       ('Grace', 'Moore', 'grace.moore@example.com', 'grace_moore', 'password123', 3),             -- User
       ('Hank', 'Taylor', 'hank.taylor@example.com', 'hank_taylor', 'password123', 3),             -- User
       ('Ivy', 'Anderson', 'ivy.anderson@example.com', 'ivy_anderson', 'password123', 3),          -- User
       ('Jack', 'Thomas', 'jack.thomas@example.com', 'jack_thomas', 'password123', 1),             -- Admin
       ('Karen', 'Jackson', 'karen.jackson@example.com', 'karen_jackson', 'password123', 3),       -- User
       ('Leo', 'White', 'leo.white@example.com', 'leo_white', 'password123', 3),                   -- User
       ('Mia', 'Harris', 'mia.harris@example.com', 'mia_harris', 'password123', 3),                -- User
       ('Nina', 'Martin', 'nina.martin@example.com', 'nina_martin', 'password123', 3),             -- User
       ('Oscar', 'Garcia', 'oscar.garcia@example.com', 'oscar_garcia', 'password123', 3),          -- User
       ('Paul', 'Martinez', 'paul.martinez@example.com', 'paul_martinez', 'password123', 3),       -- User
       ('Quincy', 'Robinson', 'quincy.robinson@example.com', 'quincy_robinson', 'password123', 3), -- User
       ('Rita', 'Clark', 'rita.clark@example.com', 'rita_clark', 'password123', 3),                -- User
       ('Sam', 'Rodriguez', 'sam.rodriguez@example.com', 'sam_rodriguez', 'password123', 3); -- User
